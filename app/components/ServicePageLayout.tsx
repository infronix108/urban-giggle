...
interface ServicePageProps {
  ...
  customSitesSection?: ReactNode;
  contactHeading?: string;
  customContactSection?: ReactNode;
}
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {customContactSection ? (
          <div className="bg-white/10 p-8 rounded-lg backdrop-blur-sm">
            <h2 className="text-3xl font-semibold mb-6 text-electric-blue">{contactHeading || 'Contact Us'}</h2>
            {customContactSection}
          </div>
        ) : (
          <div className="bg-white/10 p-8 rounded-lg backdrop-blur-sm">
            <h2 className="text-3xl font-semibold mb-6 text-electric-blue">{contactHeading || 'Get Started'}</h2>
