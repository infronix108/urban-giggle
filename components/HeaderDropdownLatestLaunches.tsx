...
const services: Service[] = [
  ...
  },
  {
    ...
    slug: "career-support",
    description: "Students can talk to advisors about careers"
  }
]

export default function HeaderDropdownLatestLaunches() {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute right-0 mt-2 w-[300px] bg-deep-blue rounded-lg shadow-lg border border-gray-800 z-50"
          >
              ...
              {services.map((service) => (
                ...
                >
                  <Link
                    ...
                    className="flex items-center justify-between w-full px-4 py-3 text-white hover:bg-gray-800 transition-colors"
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute left-0 right-0 bg-gray-800 text-sm text-gray-400 px-4 py-2 overflow-hidden"
                  >
                    {service.description}
                  </motion.div>
                </motion.li>
